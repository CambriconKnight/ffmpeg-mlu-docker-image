...
./transcoder_vid2vid ../../data/test200.h264 352 288 0 1 1
#./transcoder_vid2vid ../../data/A002.mp4 352 288 0 1 1
#./transcoder_vid2vid rtsp://username1:password1@10.100.9.70:8554/cars-6.mkv 352 288 0 1 1
echo -e "${green}"
# 2.2. 查看转码后的视频文件
ls -lh ./_thread_*.h264
